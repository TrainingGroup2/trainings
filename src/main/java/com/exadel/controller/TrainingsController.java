...
public class TrainingsController {
    ...
    static {
        ...
        trainings.add(new Training("1", "Marina", "204", new Date(), new Date(), trainer, "developers", "rus", 4.5, 32, 2, TrainingStatus.approved, null, null));
        trainings.add(new Training("2", "Petya", "205", new Date(), new Date(), trainer, "developers", "eng", 2.7, 27, 11, TrainingStatus.cancelled, null, null));
        trainings.add(new Training("3", "Ivan", "206", new Date(), new Date(), trainer, "developers", "blr", 4.7, 102, 12, TrainingStatus.drafted, null, null));
    }
